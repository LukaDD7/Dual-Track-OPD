...
CUDA_TOOLCHAIN="${EVAL_CUDA_TOOLCHAIN:-${DTOPD_ROOT}/envs/cuda128-toolchain}"
...
EVAL_CKPT="${EVAL_CKPT:-${SFT_RL_MODEL_HF:-${DTOPD_ROOT}/projects/Dual-Track-OPD/third_party/Vision-OPD/checkpoints/Vision-OPD-Qwen3.5-4B/global_step_65}}"
