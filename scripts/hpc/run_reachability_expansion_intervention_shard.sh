...
[[ -f "${PROPOSAL_MERGED}/retained_proposals.jsonl" ]] || { echo "FATAL: missing merged proposals ${PROPOSAL_MERGED}/retained_proposals.jsonl" >&2; exit 1; }
