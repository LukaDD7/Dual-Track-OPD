...
HF_HOME="${SFT_RL_HF_CACHE:-/inspire/hdd/global_user/mengweicheng-240108120092/lzy/.cache/huggingface}"
export HF_HOME
mkdir -p "${HF_HOME}"

PY=/inspire/hdd/global_user/mengweicheng-240108120092/lzy/envs/vision-opd-cu128/bin/python
